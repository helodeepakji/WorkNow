              ...
              <div className="item1">
                <div className='jh'>
                  ...
                  <div className='cls'>
                    ...
                    <input type="number" name="phone" placeholder="Your Phone Number" value={formData.phone} onChange={handleChange}></input>
                  </div>
              ...
              <div class="item2">
                <div>
                  <div className='cls'>
                    ...
                    <input type="file" placeholder="Your photo" name="profile" onChange={handleChange}></input>
                  </div>
